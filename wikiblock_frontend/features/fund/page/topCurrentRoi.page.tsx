...
const TopCurrentRoiPage = () => {
  ...
  return (
    <DefaultLayout withSidebar dataSidebar={dataFund as any}>
      <TopFunds namePage={t("fund:menu.top_funds_by_current_roi")} description="Số liệu được tổng hợp và cập nhật liên tục bởi abcxyz" />
    </DefaultLayout>
  );
};

export default TopCurrentRoiPage;